# ai_copilot.py
# -----------------------------------------------------------------------------
# EUSEE AI Copilot module
# Extracted from app.py for easier maintenance.
# Keep dashboard layout/data filtering in app.py; keep all chatbot/OpenAI/plot
# builder logic here.
# -----------------------------------------------------------------------------
...
try:
    from authz import has_permission, get_current_email, get_current_role
except Exception:

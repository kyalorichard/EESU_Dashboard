...
# ---------------- EXECUTIVE TYPOGRAPHY AND SPACING SYSTEM ----------------
def inject_executive_typography_spacing_system():
    """
    Final visual normalization layer.

    Scope:
    - Standardizes typography, spacing, form controls, cards, tabs, tables and chart containers.
    - Does not change data, filters, permissions, navigation, downloads, chart logic, or page content.
    - Loaded after earlier CSS so it acts as a safe executive-polish override.
    """
    st.markdown("""
    <style>
    :root {
        --eusee-font: Arial, Helvetica, sans-serif;
        --eusee-page-bg: #F7F8FB;
        --eusee-surface: #FFFFFF;
        --eusee-surface-soft: #FCFAFF;
        --eusee-border-soft: #E6E8EF;
        --eusee-border-purple: rgba(102, 0, 148, 0.14);
        --eusee-text-main: #232633;
        --eusee-text-sub: #667085;
        --eusee-text-heading: #23152F;
        --eusee-radius-sm: 10px;
        --eusee-radius-md: 14px;
        --eusee-radius-lg: 18px;
        --eusee-shadow-card: 0 10px 24px rgba(16, 24, 40, 0.060);
        --eusee-shadow-soft: 0 6px 16px rgba(16, 24, 40, 0.045);
        --eusee-space-xs: 4px;
        --eusee-space-sm: 8px;
        --eusee-space-md: 12px;
        --eusee-space-lg: 16px;
    ...
    html, body, .stApp, [data-testid="stAppViewContainer"] {
        background: var(--eusee-page-bg) !important;
        font-family: var(--eusee-font) !important;
        color: var(--eusee-text-main) !important;
    ...
    .main .block-container {
        ...
        padding-left: clamp(0.85rem, 1.4vw, 1.45rem) !important;
        padding-right: clamp(0.85rem, 1.4vw, 1.45rem) !important;
        padding-bottom: 6.5rem !important;
    }

    /* Global text rhythm */
    h1, h2, h3, h4, h5, h6,
    .stMarkdown, .stMarkdown p, .stCaption, label, span, div, p, li {
        font-family: var(--eusee-font) !important;
    }

    .stMarkdown p, .stCaption, p, li {
        font-size: 12.5px !important;
        line-height: 1.48 !important;
        color: var(--eusee-text-main);
    }
    ...
    h2 {
        ...
        font-weight: 850 !important;
        color: var(--eusee-text-heading) !important;
    ...
    .animated-subtitle {
        ...
        font-size: clamp(12.2px, 1vw, 13.2px) !important;
        line-height: 1.48 !important;
    ...
    /* Streamlit vertical rhythm */
    div[data-testid="stVerticalBlock"] { gap: 0.72rem !important; }
    div[data-testid="stHorizontalBlock"] { gap: 0.82rem !important; }
    div[data-testid="column"] { padding-left: 0.18rem !important; padding-right: 0.18rem !important; }
    hr { margin: 0.8rem 0 !important; border-color: var(--eusee-border-soft) !important; }

    /* Tabs: compact, readable, responsive */
    div[data-testid="stTabs"] [role="tablist"] {
        gap: 6px !important;
        border-bottom: 1px solid #E9E2F2 !important;
    ...
    div[data-testid="stTabs"] button[aria-selected="true"] {
        ...
        background: #FFFFFF !important;
        box-shadow: inset 0 -2px 0 #660094 !important;
    }

    /* Sidebar: executive density without scrolling clutter */
    section[data-testid="stSidebar"] {
        background: linear-gradient(180deg, #FFFFFF 0%, #F8F7FB 100%) !important;
        border-right: 1px solid var(--eusee-border-soft) !important;
    }
    ...
    section[data-testid="stSidebar"] .stMarkdown p {
        ...
        color: var(--eusee-text-sub) !important;
    }
    ...
    input {
        ...
        font-size: 12px !important;
        box-shadow: 0 1px 2px rgba(16,24,40,.040) !important;
    }
    ...
    .map-overview-guide,
    .map-guide-card,
    .dashboard-user-guide-card,
    .user-manual-card {
        border-radius: var(--eusee-radius-lg) !important;
        box-shadow: var(--eusee-shadow-card) !important;
    }

    /* KPI and analytical cards: standard scale */
    .eusee-kpi-card,
    .negintel-card {
    ...
    /* Plotly chart shell and chart text harmony */
    div[data-testid="stPlotlyChart"] {
        background: #FFFFFF !important;
        border: 1px solid #E9E2F2 !important;
        border-radius: var(--eusee-radius-lg) !important;
        padding: 10px 11px 6px 11px !important;
        margin: 4px 0 14px 0 !important;
        box-shadow: 0 10px 25px rgba(45, 0, 85, 0.052) !important;
    }
    ...
    /* Tables and dataframe readability */
    div[data-testid="stDataFrame"] {
    ...
    /* Feedback widget should remain compact and premium */
    #eusee-feedback-floating-root,
    #eusee-feedback-floating-root * {
        font-family: var(--eusee-font) !important;
    }

    #eusee-feedback-floating-root .eusee-feedback-toggle {
        font-size: 11.5px !important;
        min-height: 36px !important;
    }

    #eusee-feedback-floating-root .eusee-feedback-panel-copy {
        font-size: 11.5px !important;
    ...
    @media (max-width: 800px) {
        html, body, .stApp { font-size: 12.5px !important; }
        div[data-testid="stHorizontalBlock"] { gap: 0.62rem !important; }
        .eusee-kpi-card, .negintel-card { min-height: auto !important; }
        .eusee-kpi-value, .negintel-value { font-size: 28px !important; }
        div[data-testid="stPlotlyChart"] { padding: 8px 8px 4px 8px !important; }
        div[data-testid="stDataFrame"] [role="gridcell"] { font-size: 11px !important; }
    }
    ...
    @media (max-width: 560px) {
        ...
        h1, .animated-title { font-size: 28px !important; }
        h2 { font-size: 19px !important; }
        h3 { font-size: 16px !important; }
        .animated-subtitle { font-size: 12px !important; }
...
inject_executive_typography_spacing_system()
...
def apply_classic_chart_theme(fig, title=None, height=None, horizontal=False, showlegend=True):
    ...
    fig.update_layout(
        ...
        font=dict(family=CHART_FONT, size=11.5, color=CHART_TEXT_COLOR),
        title=dict(
            ...
            y=0.98,
            yanchor="top",
            font=dict(family=CHART_FONT, size=14.5, color=CHART_TITLE_COLOR),
        ),
